            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="border-l-4 border-amber-600 pl-6">
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">1965 - Stigting</h3>
                  <p className="text-gray-600">
                ...
                <div className="border-l-4 border-amber-600 pl-6">
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">1974 - Kerkgebou</h3>
                  <p className="text-gray-600">
                ...
                <div className="border-l-4 border-amber-600 pl-6">
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">Vandag</h3>
                  <p className="text-gray-600">
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1">Skrifgetrouheid</h4>
                    <p className="text-gray-600">Ons glo in die onfeilbaarheid en gesag van die Bybel as God se Woord.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1">Gemeenskap</h4>
                    <p className="text-gray-600">Ons bou betekenisvolle verhoudings en ondersteun mekaar in geloof.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1">Evangelisasie</h4>
                    <p className="text-gray-600">Ons is toegewy aan die verspreiding van die Evangelie plaaslik en internasionaal.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1">Diensbaarheid</h4>
                    <p className="text-gray-600">Ons moedig lidmate aan om hul gawes te gebruik in diens van God en die gemeenskap.</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-1">Genade</h4>
                    <p className="text-gray-600">Ons verwelkom almal met ope arms, ongeag agtergrond of omstandighede.</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg p-6 shadow-sm">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    <span className="text-gray-600">Stigtingsdatum:</span>
                    <span className="font-medium">16 Oktober 1965</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Eerste Predikant:</span>
                    <span className="font-medium">Ds. J.H. Boneschans</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Afgestig van:</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-2">Bedieningsgebied</h4>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2">Hoofkerk</h4>
                    <p className="text-gray-600">Eredienste en spesiale geleenthede</p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2">Kerksaal</h4>
                    <p className="text-gray-600">450 sitplekke vir byeenkomste</p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2">Katkisasielokale</h4>
                    <p className="text-gray-600">12 klaskamers vir onderrig</p>
                  </div>
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2">Parkering</h4>
                    <p className="text-gray-600">Voldoende parkering beskikbaar</p>
                  </div>
                </div>

                <div className="pt-4 border-t border-gray-200">
                  <h4 className="font-semibold text-gray-900 mb-2">Toeganklikheid</h4>
                  <p className="text-gray-600 text-sm">

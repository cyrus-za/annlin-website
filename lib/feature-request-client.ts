...
const detailCache = new Map<string, FeatureRequestDetail>()
...
export function getCachedFeatureRequest(id: string) {
  return detailCache.get(id) ?? null
}

export function cacheFeatureRequest(detail: FeatureRequestDetail) {

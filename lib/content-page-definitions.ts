    ...
    groups: [
      {
        title: 'Hoofbanier',
        fields: [
          text('hero.subtitle', 'Gemeentenaam'),
  ...
  },
  {
    ...
    sections: {
      ...
      ministryAreas: {
        ...
        pastoralTitle: 'Pastoraal',
        pastoralBody: 'Ons help mekaar om Christus in ons daaglikse lewe te volg.',
        diaconalTitle: 'Diakonaal',
        diaconalBody: 'Ons dien met die gawes wat die Gees ons gegee het.',
        missionalTitle: 'Missionaal',
        missionalBody: 'Ons straal Jesus in ons daaglikse lewe uit.',
        supportBody: 'Ondersteuningsgroepe bied die administratiewe en logistieke ondersteuning wat hierdie bedieninge moontlik maak.',
      },
      doctrine: {
        title: 'Ons Leer',
        body: 'Ons gemeente glo dat die Heilige Skrif die Woord van God is, dat dit die volmaakte leer van die saligheid bevat, en ons verwerp alle leringe wat daarmee in stryd is.',
      ...
      emblem: {
        ...
        circleTitle: 'Die kring',
        circleBody: 'Die soliede kring om die kruis simboliseer God die Vader wat in sy genade sy enigste Seun gegee het, sodat dié wat in Hom glo die ewige lewe kan hê (Johannes 3:16).',
        haloTitle: 'Die stralekrans',
        haloBody: 'Die stralekrans simboliseer God se heerlikheid, Christus se opstanding en sy koningskap (Filippense 4:20; Hebreërs 10:12).',
        waterTitle: 'Die strome water',
        waterBody: 'Die strome simboliseer die lewende water wat by Jesus te vind is, die Heilige Gees wat uitgestort is en die evangelie wat die wêreld invloei (Johannes 4:13; 7:38-39; Handelinge 1:8).',
        peopleTitle: 'Die mensfigure',
    ...
    groups: [
      ...
      {
        title: 'Diensterreine en leer',
        fields: [
          text('ministryAreas.title', 'Diensterreine-opskrif'),
          area('ministryAreas.body', 'Diensterreine-inleiding'),
          text('ministryAreas.spiritualTitle', 'Spirituele terrein'),
          area('ministryAreas.spiritualBody', 'Spirituele terrein se teks'),
          text('ministryAreas.pastoralTitle', 'Pastorale terrein'),
          area('ministryAreas.pastoralBody', 'Pastorale terrein se teks'),
          text('ministryAreas.diaconalTitle', 'Diakonale terrein'),
          area('ministryAreas.diaconalBody', 'Diakonale terrein se teks'),
          text('ministryAreas.missionalTitle', 'Missionale terrein'),
          area('ministryAreas.missionalBody', 'Missionale terrein se teks'),
          area('ministryAreas.supportBody', 'Ondersteuningsbediening'),
          text('doctrine.title', 'Leer-opskrif'),
          area('doctrine.body', 'Leer-teks'),
          area('doctrine.confessions', 'Belydenisskrifte'),
        ],
      },
      {
        title: 'Ons embleem',
        fields: [
          text('emblem.title', 'Afdelingopskrif'),
          area('emblem.body', 'Inleidende teks'),
          text('emblem.crossTitle', 'Kruis-opskrif'),
          area('emblem.crossBody', 'Kruis-teks'),
          text('emblem.circleTitle', 'Kring-opskrif'),
          area('emblem.circleBody', 'Kring-teks'),
          text('emblem.haloTitle', 'Stralekrans-opskrif'),
          area('emblem.haloBody', 'Stralekrans-teks'),
          text('emblem.waterTitle', 'Water-opskrif'),
          area('emblem.waterBody', 'Water-teks'),
          text('emblem.peopleTitle', 'Mensfigure-opskrif'),
          area('emblem.peopleBody', 'Mensfigure-teks'),
        ],
      },
      {
